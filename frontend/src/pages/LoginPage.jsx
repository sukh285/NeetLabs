...
const LoginPage = () => {
  ...
  return (
    <div className="relative pb-5 w-full min-h-screen overflow-hidden bg-gradient-to-br from-neet-neutral via-neet-primary to-neet-neutral font-inter">
      ...
      >
        <div className="w-full max-w-5xl flex flex-col sm:flex-row items-center justify-around gap-10 space-y-8 sm:space-y-0 transition-opacity duration-300">
          {/* Form */}
            ...
            <div className="bg-neet-neutral/30 backdrop-blur-xl rounded-2xl p-6 shadow-2xl border border-neet-base-100/30 hover:shadow-neet-secondary/20 transition-all duration-300">
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                <div className="bg-yellow-50 text-yellow-800 text-xs pointer-events-none text-center px-4 py-2 rounded-md border border-yellow-300 mb-2">
                  ...
                  accounts. <br />
                  Please use <strong>Google</strong> or <strong>GitHub</strong>{" "}
                  to login.
                </div>
          ...
          {/* Oauth */}
          <div className="w-full sm:max-w-xs bg-neet-neutral/30 backdrop-blur-xl rounded-2xl p-6 shadow-2xl border border-neet-base-100/30 hover:shadow-neet-secondary/20 transition-all duration-300">
            ...
            {/* OAuth Buttons Column (stacked vertically) */}
