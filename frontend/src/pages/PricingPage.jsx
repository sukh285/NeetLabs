...
import { Check, Zap, Crown, Star, Bot, Target, Users, TrendingUp, StarsIcon } from 'lucide-react';
...
const PricingPage = () => {
  const plans = [
    {
      ...
      buttonStyle: "border-2 border-neet-neutral/30 bg-neet-neutral/60 text-neet-primary cursor-not-allowed",
    ...
    },
    {
      ...
      buttonStyle: "bg-gradient-to-r from-neet-primary to-neet-secondary hover:from-neet-primary-focus hover:to-neet-secondary-focus text-white shadow-lg hover:shadow-xl",
      cardStyle: "border-2 border-neet-primary/30 bg-white shadow-2xl shadow-neet-primary/10 backdrop-blur-sm transform hover:scale-105",
      badge: "Most Popular",
    ...
    },
    {
      ...
      buttonStyle: "border-2 border-neet-neutral/30 bg-white hover:bg-neet-neutral/5 text-neet-neutral",
  ...
  // Bottom section content as a reusable component
  const BottomSection = () => (
    <div className="text-center mt-16 pt-8 border-t border-neet-base-200">
      <div className="inline-flex items-center gap-8 text-sm text-neet-neutral/60">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 flex-1 flex flex-col">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-neet-accent-200 backdrop-blur-sm rounded-full border border-neet-accent/20 mb-6">
            ...
            <span className="text-neet-accent font-medium text-sm">Pricing</span>
          </div>
          ...
          {plans.map((plan, index) => {
            ...
            return (
              <div
                key={index}
                className={`
                  relative rounded-2xl p-8 transition-all duration-300 hover:shadow-2xl flex flex-col
                  ${plan.cardStyle}
                  ${plan.popular ? 'lg:-mt-4 lg:mb-4' : ''}
                `}
                style={{ minHeight: '540px' }} // Ensures cards are tall enough for alignment
              >
                {/* Badge */}
                {plan.badge && (
                  <div className={`
                  ...
                  {plan.features.map((feature, featureIndex) => (
                    <div key={featureIndex} className="flex items-start gap-3">
                      <div className="flex-shrink-0 w-5 h-5 rounded-full bg-neet-neutral/80 flex items-center justify-center mt-0.5">
                        <Check className="w-3 h-3 text-neet-success" />
                      </div>
