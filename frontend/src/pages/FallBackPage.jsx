  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center font-inter bg-gradient-to-br from-neet-neutral via-neet-neutral-focus to-neet-neutral">
      <div
        ...
        className="w-full max-w-sm mx-auto bg-neet-neutral/30 backdrop-blur-xl rounded-2xl p-8 shadow-2xl border border-neet-base-100/30 flex flex-col items-center justify-center gap-6"
      >
