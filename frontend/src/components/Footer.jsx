  ...
  return (
    <footer className="relative font-inter bg-gradient-to-r from-neet-neutral/90 via-neet-neutral to-neet-neutral/90 border-t border-neet-primary/20 backdrop-blur-sm overflow-hidden">
      ...
      <div className="absolute bottom-12 left-1/2 transform -translate-x-1/2 translate-y-1/2 opacity-20 z-0">
        <span className="text-[300px] font-limelight font-bold text-neet-primary">
          NeetLabs
        </span>
      </div>
      ...
      <div
        ...
        className="relative z-10 px-4 lg:px-8 py-12 lg:py-16"
      >
              ...
              <div className="space-y-4">
                ...
                <div className="flex space-x-4 mt-6">
                  <a
                    ...
                    className="w-9 h-9 rounded-full bg-neet-base-100/10 backdrop-blur-sm border border-neet-base-100/20 flex items-center justify-center hover:bg-neet-primary/20 hover:border-neet-primary/40 transition-all duration-300"
                  >
